# Descartes Certainty Lab v26/94

面向中文用户、读屏用户和自主学习者的交互式哲学学习应用。

项目把哲学史内容组织成可逐步学习的路线，以思想实验、分层讲解、理解检查和结构化引用降低系统学习门槛。v26/94 包含 **94 条哲学家学习路线**和 **185 个知识目录条目**，运行于 Windows WPF。
...
pwsh -NoProfile -File .\tools\regression-audit\Invoke-V26-94-RegressionAudit.ps1 -NoReport
```
...
v26/94 已通过源码、构建、测试及 portable artifact 的独立机器复核；产品 UI、Narrator、NVDA、UIA 和物理键盘流程仍保留人工验证门。
...
本仓库当前仍是公开发布候选，不代表已经正式发布。当前维护里程碑见 [W4 / 94 路线维护记录](docs/W4_94_MAINTENANCE_MILESTONE.md)；上一稳定版本说明仍保留在 [v25/90 中文发布说明](docs/RELEASE_NOTES_V25_90_ZH.md)。
